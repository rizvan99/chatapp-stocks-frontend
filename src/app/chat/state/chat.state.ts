...
import {ChatClientLoggedIn, ListenForClients, LoadClientFromStorage, StopListeningForClients, UpdateClients} from './chat.action';
...
export class ChatState {
  ...
  currentClient: ChatClient | undefined;
  ...
  chatClientLoggedIn(ctx: StateContext<ChatStateModel>, clientLoggedInAction: ChatClientLoggedIn): void {
    ...
    this.currentClient = state.loggedInClient;
    ctx.setState(newState);
  }
